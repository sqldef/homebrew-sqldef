class Mssqldef < Formula
  ...
  url 'https://github.com/sqldef/sqldef.git', tag: 'v3.11.10'
  ...
  def install
    ...
    system 'curl', '-o', 'mssqldef.zip', '-sL', "https://github.com/sqldef/sqldef/releases/download/v#{version}/mssqldef_#{os}_#{arch}.zip"
